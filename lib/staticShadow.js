...
/**
 * @typedef {Object} Options - [staticShadow()]{@link staticShadow} options
...
process.on('message', async (message) => {
  if (message.type === 'render') {
    ...
    const { html: renderedHTML } = await staticShadow(html, scripts, options)
